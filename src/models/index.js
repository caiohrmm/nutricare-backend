...
Refeicao.belongsToMany(Alimento, { through: ItemRefeicao, foreignKey: "refeicao_id" });
Alimento.belongsToMany(Refeicao, { through: ItemRefeicao, foreignKey: "alimento_id" });
...
module.exports = { sequelize, defineModels, Nutricionista, Paciente, Consulta, PlanoAlimentar, Refeicao, Alimento, ItemRefeicao };
